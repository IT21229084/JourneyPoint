        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className='create-job-flex'>
            ...
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="Date" placeholder="Ex: 2024-02-10" defaultValue={postingDate}
          ...
          <div className='create-job-flex'>
            ...
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="url" defaultValue={companyLogo} placeholder="paste your company logo URL: https://wetransfer.com/"
